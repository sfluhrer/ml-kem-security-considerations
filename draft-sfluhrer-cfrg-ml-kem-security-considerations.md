...
On the other hand, Bob can generate a number of ciphertext/shared key pairs, and select the secret key that he prefers.  This gives him some level of control (and this is inherent in any one-pass key agreement mechanism), but he cannot freely choose it.  
